...
C++ does \textbf{not} check if you stay inside the array boundaries.\pause{} Accessing \texttt{arr[10]} of a size-5 array is technically allowed by the compiler but causes \textbf{Undefined Behavior}.\pause
...
You will complete the function bodies for:\pause
\begin{enumerate}
