...
\item Next slide shows the visual flow that applies to both loop types.
\end{itemize}
\end{frame}
...
\item Next slide illustrates what happens when you try to access a loop variable outside its scope.
\end{itemize}
\end{frame}
...
\item Next slide shows a visual representation of this concept.
\end{itemize}
\end{frame}
...
\item Next slides show examples with different nesting depths.
\end{itemize}
\end{frame}
...
\item Next slide visualizes this concept.
\end{itemize}
\end{frame}
...
\item Next slide shows conceptual breakdown with smaller number.
\end{itemize}
\end{frame}
