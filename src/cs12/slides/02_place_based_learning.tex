...
% Define DS9-inspired color scheme
...
\begin{frame}{Place-Based Knowledge: Foundations}
    \begin{columns}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.75\linewidth]{th-1448775654.jpg}
        \end{figure}
    \end{columns}
...
\begin{frame}{Observational Expertise}
   ...
   \begin{figure}
       \centering
       \includegraphics[width=0.3\linewidth]{dreamstimelarge_30217815-copy-3469505236.jpg}
   \end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{obsstar.png}
\end{figure}
\end{frame}
\begin{frame}{
}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{p06-maori-astronomy-3086117367.png}
\end{figure}
\end{frame}
\begin{frame}
\begin{figure}
