...
\note{[P0] [Fig 16.12: Cassegrain telescope] "Parabolic mirrors have special property"\\\\
...
\end{block}
\note{[P0] [Fig 16.16: Fish tank refraction] "Light bending at boundary between media"\\\\
...
$\theta_c = \sin^{-1}(1.00/1.33) = 48.6^\circ$
...
\note{[P0] [Fig 16.22: Binoculars TIR] "Why diamonds sparkle"\\\\
...
\pause
\textbf{Substitute:} $\sin\theta_2 = \frac{(1.00)(\sin 45.0^\circ)}{1.50} = \frac{0.707}{1.50}$

\pause
$$\sin\theta_2 = 0.471$$

\pause
$$\boxed{\theta_2 = \sin^{-1}(0.471) = 28.1^\circ}$$
...
\note{[P0] [Fig 16.34: Eye diagram] "The eye as optical instrument"\\\\
...
\note{[P0] [Fig 16.28: Virtual images] "Two common vision defects"\\\\
...
\note{[P0] [Fig 16.31: Lens correction] "Correcting vision with eyeglasses"\\\\
