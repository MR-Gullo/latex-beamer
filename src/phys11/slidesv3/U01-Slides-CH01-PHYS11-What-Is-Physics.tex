...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-physics-fig1-1.jpg}
\end{figure}
...
\end{exampleblock}
\note{[P0][Fig 1.1: Galaxies, such as the]  "The Andromeda galaxy - 2.5 million light years away, billions of stars"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-physics-fig1-3.jpg}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-physics-fig1-3.jpg}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-physics-fig1-4.jpg}
\end{figure}
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-physics-fig1-5.jpg}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-physics-fig1-6.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-physics-fig1-7.jpg}
\end{figure}
...
\column{0.48\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{phys11-physics-fig1-9.jpg}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-physics-fig1-10.jpg}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-physics-fig1-11.jpg}
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-physics-fig1-12.jpg}
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-physics-fig1-13.jpg}
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-physics-fig1-15.jpg}
...
\begin{center}
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{phys11-physics-fig1-21.jpg}
...
\column{0.32\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{phys11-physics-fig1-22.jpg}
...
\column{0.32\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{phys11-physics-fig1-23.jpg}

\tiny Accurate and precise
\end{center}
\end{columns}
\note{[P0][Fig 1.21: A GPS system attempts]  "GPS trying to locate a restaurant - three patterns"\\\\
