...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-what-is-physics-fig1-1.jpg}
\end{figure}
...
\end{exampleblock}
\note{[P0][Fig 1.1: Andromeda galaxy] "The Andromeda galaxy - 2.5 million light years away, billions of stars. Teaching hint: Point out that we see it as it was 2.5M years ago - light travel time connects space and time."\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-what-is-physics-fig1-2.jpg}
\end{figure}
...
\end{itemize}
\end{exampleblock}
\note{[Fig 1.2: Smartphone with GPS] "Name wheel: what physics is in your phone? Teaching hint: GPS satellites must account for Einstein's relativity - time runs faster in orbit than on Earth by 38 microseconds/day. Without corrections, GPS would drift 10km/day."\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-3.jpg}
\end{figure}

\pause
Built 3000-1000 BC as an astronomical observatory.
\note{[Fig 1.3: Stonehenge observatory] "Ancient people studied kinematics: motion of objects. Teaching hint: Stones align with solstices and lunar events - shows humans have always sought patterns in nature. Physics began with observation before mathematics."\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-4.jpg}
\end{figure}
...
\end{itemize}
\note{[Fig 1.4: Earth warping spacetime mesh] "Einstein revolutionized physics in 1905. Teaching hint: The mesh visualization shows mass doesn't 'pull' - it curves space itself, and objects follow the curves. Like a marble rolling on stretched fabric."\\\\
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-what-is-physics-fig1-5.jpg}
...
\end{itemize}
\note{[Fig 1.5: Gold atoms via STM] "Quantum mechanics: the physics of atoms. Teaching hint: STM doesn't 'see' atoms with light - it measures electron tunneling current. Shows how we extend observation beyond human senses."\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-6.jpg}
...
\note{[Fig 1.6: Fermilab accelerator] "Large Hadron Collider: 27 km long tunnel. Teaching hint: At 99.999\% light speed, particles experience time dilation - a microsecond for the particle equals hours in the lab. Direct application of relativity."\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-what-is-physics-fig1-7.jpg}
\end{figure}
...
\end{alertblock}
\note{[Fig 1.7: Microwave oven] "Turn and talk: who has seen sparks in microwave? Teaching hint: Microwaves are EM radiation at 2.45 GHz - resonant frequency that excites water molecules. Metal reflects/concentrates the waves, creating intense electric fields."\\\\
...
\column{0.48\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-8.jpg}
...
\column{0.48\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-9.jpg}
...
\note{[Fig 1.8: MRI brain scan | Fig 1.9: Onion cells] "MRI: magnetic resonance imaging. Teaching hint: MRI uses nuclear magnetic resonance - hydrogen nuclei align with magnetic field, then emit radio signals when field changes. No ionizing radiation unlike X-rays."\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-10.jpg}
...
\note{[Fig 1.10: Rosetta spacecraft] "Traveled 6.4 billion km from Earth. Teaching hint: Landing on 4km comet requires precise orbital mechanics - match velocity with object moving 135,000 km/h while both orbit the sun. Shows Newton's laws at work."\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-what-is-physics-fig1-11.jpg}
...
\note{[Fig 1.11: Voyager trajectories] "Voyager 2 used Saturn's gravity to slingshot to Uranus and Neptune. Teaching hint: Gravity assists are elastic collisions with planets - spacecraft steals tiny bit of planet's orbital momentum. Conservation of energy and momentum in action."\\\\
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-what-is-physics-fig1-12.jpg}
...
\note{[Fig 1.12: Electron cloud model] "This is quantum mechanical model. Teaching hint: Heisenberg uncertainty principle - can't know exact position and momentum simultaneously. Clouds represent probability density - darker regions mean higher likelihood."\\\\
...
\begin{center}
\Large $\boxed{\force{F} = \mass{m}\accel{a}}$
\end{center}
\force{Force} equals \mass{mass} times \accel{acceleration}. Works on Earth, Mars, and distant galaxies.
\end{block}
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-what-is-physics-fig1-13.jpg}
...
\note{[Fig 1.13: Person confused by cable units] "Imagine measuring distance in 'steps'. Teaching hint: This shows why standardization matters - a 'cable' was historically 720 feet in nautical use, but varies by context. Physics requires universal standards."\\\\
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-what-is-physics-fig1-15.jpg}
...
\note{[Fig 1.15: Atomic clock] "Old definition: fraction of solar day. Teaching hint: Cesium-133 hyperfine transition is nature's perfect metronome - electromagnetic frequency between electron spin states. Shows quantum mechanics enabling practical technology."\\\\
...
\textbf{Step 1:} Average \vel{speed} = $\frac{\text{\disp{distance}}}{\text{\tvar{time}}}$
...
$$\vel{v}_{\text{avg}} = 0.500 \frac{\text{km}}{\text{min}} \times \frac{60 \text{ min}}{1 \text{ h}} = \boxed{30.0 \text{ km/h}}$$
...
\begin{center}
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{phys11-what-is-physics-fig1-21.jpg}
...
\column{0.32\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{phys11-what-is-physics-fig1-22.jpg}
...
\column{0.32\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{phys11-what-is-physics-fig1-23.jpg}

\tiny Accurate and precise
\end{center}
\end{columns}
\note{[P0][Fig 1.21-23: GPS accuracy/precision targets] "GPS trying to locate a restaurant - three patterns. Teaching hint: Systematic error (like miscalibrated sensor) causes precision without accuracy. Random error causes opposite. Best instruments minimize both."\\\\
...
\begin{align}
\vel{v}_{\text{avg}} &= \frac{\disp{d}}{\tvar{t}} \\
\text{Percent uncertainty} &= \frac{\delta A}{A} \times 100\%
\end{align}
