...
\textbf{Find:} Average velocity over entire time interval (0 to 20 min)
...
\textbf{Step 1:} Identify endpoints: $(t_0, d_0) = (0, 0)$ km and $(t_f, d_f) = (20, 0)$ km
...
$$v_{\text{avg}} = \frac{0 - 0 \text{ km}}{20 - 0 \text{ min}} = \boxed{0 \text{ km/min}}$$

\pause
\textbf{Check:} Zero! Started and ended at same position - net displacement is zero!
