...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig02.jpg}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig03.jpg}
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig04.jpg}
...
\end{itemize}
\note{[P0] "Jet car on Bonneville Salt Flats"\\\\
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-kinematics-fig05.jpg}
...
\note{[P0] "When object speeds up, graph curves"\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig06.jpg}
...
\note{[P0] "Two tangent lines shown at different points"\\\\
...
\begin{center}
\includegraphics[width=0.6\textwidth,height=0.35\textheight,keepaspectratio]{phys11-kinematics-fig07.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth,height=0.45\textheight,keepaspectratio]{phys11-kinematics-fig08.jpg}
...
\column{0.48\textwidth}
\begin{center}
\includegraphics[width=\linewidth,height=0.45\textheight,keepaspectratio]{phys11-kinematics-fig09.jpg}
...
\note{[P0] "Position graph on left - V-shaped"\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig10.jpg}
...
\note{[P0] "Calculate area under velocity curve"\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig11.jpg}
...
\end{itemize}
\note{[P0] "Straight line means constant acceleration"\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig12.jpg}
...
\note{[P0] "Horizontal line in velocity graph"\\\\
...
\begin{exampleblock}{The Challenge (3 min, silent)}
\begin{center}
\includegraphics[width=0.5\textwidth,height=0.3\textheight,keepaspectratio]{phys11-kinematics-fig13.jpg}
\end{center}
...
\note{[P0] "Part a: displacement equals area"\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig14.jpg}
...
\end{alertblock}
\note{[P0] "More realistic graph - velocity doesn't jump instantly"\\\\
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig15.jpg}
...
\end{itemize}
\note{[P0] "Velocity can be positive or negative"\\\\
