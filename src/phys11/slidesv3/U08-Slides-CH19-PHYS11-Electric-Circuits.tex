...
Electric \current{current} is like water flowing through pipes - \voltage{voltage} is the pressure, \resist{resistance} is the friction.
\end{exampleblock}
...
\begin{center}
\Large $\boxed{\current{I} = \frac{\Delta \charge{Q}}{\Delta \tvar{t}}}$
\end{center}
\current{Current} equals \charge{charge} per unit \tvar{time}. Measured in amperes (A).
\end{block}
...
\pause
\begin{exampleblock}{The Mental Model}
If 5 coulombs flow past a point in 1 second, the \current{current} is 5 A.
\end{exampleblock}
...
\textbf{Convention:} \current{Current} flows from positive to negative.
\end{alertblock}
...
\begin{center}
\Large $\boxed{\voltage{V} = \current{I}\resist{R}}$
\end{center}
\voltage{Voltage} equals \current{current} times \resist{resistance}. The pushback equation.
\end{block}

\pause
\vspace{0.3cm}

\textbf{Units:} \resist{Resistance} measured in ohms ($\Omega$), where $1 \Omega = 1 \text{ V/A}$

\pause
\begin{exampleblock}{The Mental Model}
\resist{Resistance} is friction for electrons - it converts electrical energy to heat.
\end{exampleblock}
...
\textbf{Given:}
\begin{itemize}
\item $\particles{n} = 10^{20}$ electrons
\item $\charge{e} = -1.60 \times 10^{-19}$ C
\item $\Delta \tvar{t} = 2 \times 10^{-3}$ s
\end{itemize}

\textbf{Find:} Average \current{current} $\current{I}$
...
\begin{enumerate}
\item How did you find the total \charge{charge}?
\item What formula did you use for \current{current}?
...
\textbf{Step 1:} Total \charge{charge}: $\Delta \charge{Q} = \particles{n}\charge{e} = (10^{20})(-1.60 \times 10^{-19} \text{ C}) = -16.0 \text{ C}$

\pause
\vspace{0.2cm}

\textbf{Step 2:} \current{Current}: $\current{I} = \frac{\Delta \charge{Q}}{\Delta \tvar{t}}$

\pause
\vspace{0.2cm}

$$\current{I} = \frac{-16.0 \text{ C}}{2 \times 10^{-3} \text{ s}} = \boxed{-8 \text{ kA}}$$

\pause
\textbf{Check:} Negative sign means electrons flow down. Conventional \current{current} flows up!
...
\textbf{Given:}
\begin{itemize}
\item $\current{I} = 2.50$ A
\item $\voltage{V} = 12.0$ V
\end{itemize}

\textbf{Find:} \resist{Resistance} $\resist{R}$ of the headlight
...
\item How did you solve for $\resist{R}$?
...
\textbf{Start with Ohm's law:} $\voltage{V} = \current{I}\resist{R}$

\pause
\vspace{0.2cm}

\textbf{Solve for $\resist{R}$:} $\resist{R} = \frac{\voltage{V}}{\current{I}}$

\pause
\vspace{0.2cm}

\textbf{Substitute:} $\resist{R} = \frac{12.0 \text{ V}}{2.50 \text{ A}}$

\pause
\vspace{0.2cm}

$$\boxed{\resist{R} = 4.8 \Omega}$$

\pause
\textbf{Check:} 4.8 ohms - relatively small \resist{resistance} for a headlight.
\note{[P0] "Self-correct in a different color"\\\\
...
\begin{center}
\Large $\boxed{\resist{R}_{\text{equiv}} = \resist{R_1} + \resist{R_2} + \resist{R_3}}$
\end{center}
Series \resist{resistances} add. One path, obstacles accumulate.
\end{block}
...
\textbf{Key insight:} Going around a complete loop, \voltage{voltage} changes sum to zero.
...
For series circuit: $\voltage{V}_{\text{battery}} = \voltage{V_1} + \voltage{V_2} + \voltage{V_3}$

\pause
\vspace{0.3cm}

Using Ohm's law: $\voltage{V} = \current{I}(\resist{R_1} + \resist{R_2} + \resist{R_3})$
...
\begin{exampleblock}{The Challenge (3 min, silent)}
Three resistors in series: $\resist{R_1} = 1.0 \Omega$, $\resist{R_2} = 6.0 \Omega$, $\resist{R_3} = 13 \Omega$. Battery \voltage{voltage} is 12 V.

\vspace{0.3cm}

\textbf{Given:}
\begin{itemize}
\item $\resist{R_1} = 1.0 \Omega$, $\resist{R_2} = 6.0 \Omega$, $\resist{R_3} = 13 \Omega$
\item $\voltage{V} = 12$ V
\end{itemize}

\textbf{Find:} (a) Equivalent \resist{resistance}, (b) \current{Current} through circuit
...
\begin{enumerate}
\item How did you find equivalent \resist{resistance}?
\item What equation did you use for \current{current}?
...
\textbf{Part (a):} $\resist{R}_{\text{equiv}} = \resist{R_1} + \resist{R_2} + \resist{R_3}$

\pause
$$\resist{R}_{\text{equiv}} = 1.0 \Omega + 6.0 \Omega + 13 \Omega = \boxed{20 \Omega}$$

\pause
\vspace{0.3cm}

\textbf{Part (b):} $\current{I} = \frac{\voltage{V}}{\resist{R}_{\text{equiv}}}$

\pause
$$\current{I} = \frac{12 \text{ V}}{20 \Omega} = \boxed{0.60 \text{ A}}$$

\pause
\textbf{Check:} \voltage{Voltage} drops: $\voltage{V_1} = 0.6$ V, $\voltage{V_2} = 3.6$ V, $\voltage{V_3} = 7.8$ V. Sum = 12 V!
\note{[P0] "Self-correct in a different color"\\\\
...
\begin{center}
\Large $\boxed{\resist{R}_{\text{equiv}} = \frac{1}{\frac{1}{\resist{R_1}} + \frac{1}{\resist{R_2}} + \frac{1}{\resist{R_3}}}}$
\end{center}
Parallel \resist{resistance} is reciprocal of sum of reciprocals.
\end{block}
...
\textbf{Intuition:} More resistors means more \resist{resistance}.\\
\textbf{Reality:} Parallel resistors provide MORE paths, so LESS \resist{resistance}!
\end{alertblock}

\pause
\vspace{0.3cm}

\textbf{Key insight:} $\resist{R}_{\text{equiv}}$ is always LESS than smallest resistor in parallel.

\pause
\begin{exampleblock}{The Mental Model}
Three identical resistors $\resist{R}$ in parallel: $\resist{R}_{\text{equiv}} = \resist{R}/3$
\end{exampleblock}
...
\textbf{Key principle:} \current{Current} entering a junction equals \current{current} leaving.

\pause
\vspace{0.3cm}

For parallel resistors: $\current{I} = \current{I_1} + \current{I_2} + \current{I_3}$
...
Using Ohm's law on each: $\current{I} = \voltage{V}(\frac{1}{\resist{R_1}} + \frac{1}{\resist{R_2}} + \frac{1}{\resist{R_3}})$
...
\begin{exampleblock}{The Challenge (3 min, silent)}
Three resistors in parallel: $\resist{R_1} = 10 \Omega$, $\resist{R_2} = 25 \Omega$, $\resist{R_3} = 15 \Omega$. Battery \voltage{voltage} is 3 V.

\vspace{0.3cm}

\textbf{Given:}
\begin{itemize}
\item $\resist{R_1} = 10 \Omega$, $\resist{R_2} = 25 \Omega$, $\resist{R_3} = 15 \Omega$
\item $\voltage{V} = 3$ V
\end{itemize}

\textbf{Find:} (a) Equivalent \resist{resistance}, (b) Total \current{current}
...
\textbf{Part (a):} $\resist{R}_{\text{equiv}} = \frac{1}{\frac{1}{\resist{R_1}} + \frac{1}{\resist{R_2}} + \frac{1}{\resist{R_3}}}$

\pause
$$\resist{R}_{\text{equiv}} = \frac{1}{\frac{1}{10} + \frac{1}{25} + \frac{1}{15}} = \frac{1}{0.1 + 0.04 + 0.0667} = \boxed{4.84 \Omega}$$

\pause
\vspace{0.3cm}

\textbf{Part (b):} $\current{I} = \frac{\voltage{V}}{\resist{R}_{\text{equiv}}} = \frac{3 \text{ V}}{4.84 \Omega} = \boxed{0.62 \text{ A}}$

\pause
\textbf{Check:} 4.84 < 10 (smallest resistor). \current{Current} splits: $\current{I_1}=0.30$ A, $\current{I_2}=0.12$ A, $\current{I_3}=0.20$ A!
\note{[P0] "Self-correct in a different color"\\\\
...
\begin{center}
\Large $\boxed{\power{P} = \current{I}\voltage{V}}$
\end{center}
\power{Power} equals \current{current} times \voltage{voltage}. Energy per unit time.
\end{block}
...
\pause
\begin{exampleblock}{The Mental Model}
A 60-W bulb transfers 60 joules per second from electrical \energy{energy} to light and heat.
\end{exampleblock}
...
Using Ohm's law $\voltage{V} = \current{I}\resist{R}$, we can derive alternate forms:
...
\power{P} &= \current{I}^2\resist{R} \quad \text{(using } \voltage{V} = \current{I}\resist{R} \text{)} \\
\power{P} &= \frac{\voltage{V}^2}{\resist{R}} \quad \text{(using } \current{I} = \frac{\voltage{V}}{\resist{R}} \text{)}
\end{align}
...
They have DIFFERENT \resist{resistances}! Using $\power{P} = \frac{\voltage{V}^2}{\resist{R}}$, higher \power{power} means LOWER \resist{resistance}.
\end{alertblock}
...
\begin{itemize}
\item $\power{P} = 60$ W
\item $\voltage{V} = 120$ V
\end{itemize}

\textbf{Find:} \current{Current} through the bulb
...
\begin{enumerate}
\item Which \power{power} formula did you use?
\item How did you solve for \current{current}?
\item What units did you get?
\end{enumerate}
...
\textbf{Start with:} $\power{P} = \current{I}\voltage{V}$

\pause
\vspace{0.2cm}

\textbf{Solve for $\current{I}$:} $\current{I} = \frac{\power{P}}{\voltage{V}}$

\pause
\vspace{0.2cm}

\textbf{Substitute:} $\current{I} = \frac{60 \text{ W}}{120 \text{ V}}$

\pause
\vspace{0.2cm}

$$\boxed{\current{I} = 0.50 \text{ A}}$$

\pause
\textbf{Check:} Half an ampere - significant \current{current} for a light bulb!
\note{[P0] "Self-correct in a different color"\\\\
...
\begin{enumerate}
\item \current{Current} = \charge{charge} per \tvar{time}: $\current{I} = \frac{\Delta \charge{Q}}{\Delta \tvar{t}}$ \pause
\item Ohm's law = the pushback equation: $\voltage{V} = \current{I}\resist{R}$ \pause
\item Series \resist{resistances} add: $\resist{R}_{\text{equiv}} = \resist{R_1} + \resist{R_2} + \cdots$ \pause
\item Parallel uses reciprocals: $\resist{R}_{\text{equiv}} = \frac{1}{\frac{1}{\resist{R_1}} + \frac{1}{\resist{R_2}} + \cdots}$ \pause
\item \power{Power} = energy transfer rate: $\power{P} = \current{I}\voltage{V} = \current{I}^2\resist{R} = \frac{\voltage{V}^2}{\resist{R}}$
\end{enumerate}
\end{block}
...
\begin{align}
\current{I} &= \frac{\Delta \charge{Q}}{\Delta \tvar{t}} \quad \text{(current)} \\
\voltage{V} &= \current{I}\resist{R} \quad \text{(Ohm's law)} \\
\resist{R}_{\text{series}} &= \resist{R_1} + \resist{R_2} + \cdots + \resist{R_N} \\
\resist{R}_{\text{parallel}} &= \frac{1}{\frac{1}{\resist{R_1}} + \frac{1}{\resist{R_2}} + \cdots + \frac{1}{\resist{R_N}}} \\
\power{P} &= \current{I}\voltage{V} \\
\power{P} &= \current{I}^2\resist{R} \\
\power{P} &= \frac{\voltage{V}^2}{\resist{R}}
\end{align}
