...
\end{exampleblock}
\note{[P0][Fig 19.1: Electric energy in massive]  "Hydroelectric facility - converts water pressure to electric current"\\\\
...
\end{alertblock}
\note{[P0] [Fig 19.2: A battery has a] "Battery with wire connecting terminals"\\\\
...
\end{figure}
\note{[P0][Fig 19.6: With alternating current, the]  "Two types of current"\\\\
...
\end{itemize}
\note{[P0][Fig 19.9: On the left is]  "Circuit diagram with battery and resistor"\\\\
...
\end{block}
\note{[P0][Fig 19.16: The left circuit diagram]  "Three resistors connected head-to-tail"\\\\
...
\end{block}
\note{[Fig 19.16: three resistors in parallel with current paths]\\\\
[P0] "Three resistors connected side-by-side"\\\\
...
\end{alertblock}
\note{[P0][Fig 19.20: On the left is]  "Two light bulbs - different power ratings"\\\\
