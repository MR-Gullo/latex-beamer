...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-circuits-fig01.jpg}
\end{figure}
...
\end{exampleblock}
\note{[P0] "Hydroelectric facility - converts water pressure to electric current"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-circuits-fig02.jpg}
\end{figure}
...
\end{alertblock}
\note{[P0] "Battery with wire connecting terminals"\\\\
...
[THE HUMILITY] We're stuck with this backwards convention}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.3\textheight,keepaspectratio]{phys11-circuits-fig09.jpg}
\end{figure}
\note{[P0] "Two types of current"\\\\
[P1] "DC flows one direction - batteries, flashlights, cars"\\\\
[P2] "AC alternates back and forth - wall sockets, power grid"\\\\
- AC graph shows current reversing smoothly\\\\
- Most devices use transformers to convert AC to DC\\\\
[THE CONNECTION - Digital Archetype] Your laptop charger is really an AC-to-DC converter}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-circuits-fig20.jpg}
\end{figure}
...
\end{itemize}
\note{[P0] "Circuit diagram with battery and resistor"\\\\
...
[THE CONNECTION - Digital Archetype] Like learning to read code}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-circuits-fig28.jpg}
\end{figure}
...
\end{block}
\note{[P0] "Three resistors connected head-to-tail"\\\\
...
[THE CONNECTION - Kinetic Archetype] Like running through multiple obstacles in a row}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-circuits-fig35.jpg}
\end{figure}
...
\end{block}
\note{[P0] "Three resistors connected side-by-side"\\\\
...
[THE CONFLICT] Counterintuitive - adding resistors decreases total resistance!}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-circuits-fig55.jpg}
\end{figure}
...
\end{alertblock}
\note{[P0] "Two light bulbs - different power ratings"\\\\
...
- 60-W bulb has lower resistance than 25-W bulb\\\\
[THE WONDER] Brightness is about resistance, not just voltage}
\end{frame}
