...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-wave-optics-fig17-2.jpg}
...
\end{figure}
\note{[Fig 17.2: Paranal laser as ray + interference pattern]\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.55\textheight,keepaspectratio]{phys11-wave-optics-fig17-5.jpg}
...
\end{figure}
\note{[Fig 17.4: Huygens's principle to straight wavefront]\\\\
...
\end{itemize}
\note{[Fig 17.8: Double slits produce two wave sources]\\\\
...
\note{[Fig 17.9: Path difference d sin theta geometry]\\\\
...
\note{[Fig 17.11: Single-slit diffraction pattern]\\\\
...
\end{figure}
\note{[Fig 17.14: Opal and butterfly wings as natural gratings]\\\\
...
\end{alertblock}
\note{[Fig 17.19: Circular aperture diffraction pattern]\\\\
...
\note{[Fig 17.20: Intensity graph for circular aperture resolution]\\\\
