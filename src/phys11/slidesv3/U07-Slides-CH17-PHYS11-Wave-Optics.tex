...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-wave-optics-fig01-2.jpg}
...
\end{center}
\note{[P0] "Hold up a CD to light - you see rainbows"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth,height=0.65\textheight,keepaspectratio]{phys11-wave-optics-fig04-2.jpg}
\caption{Laser beam as ray (straight line) and wave (interference pattern after slits)}
\end{figure}
\note{- Left: laser beam from observatory - perfect ray behavior\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.55\textheight,keepaspectratio]{phys11-wave-optics-fig05-2.jpg}
...
\note{[P0] "Water waves easier to see than light waves"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-wave-optics-fig06-2.jpg}
\caption{Wavefront emitting semicircular wavelets}
\end{figure}
\note{[P0] [THE REVELATION] "Huygens's principle - 17th century Dutch scientist"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-wave-optics-fig07-4.jpg}
\caption{Huygens's principle applied to slit - edges bend}
\end{figure}
\note{[P0] [THE REVELATION] "Diffraction: wave characteristic that occurs for all waves"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.65\textheight,keepaspectratio]{phys11-wave-optics-fig07-5.jpg}
\caption{Ocean waves diffracting through opening - visible interference pattern}
\end{figure}
\note{- Incoming waves at top pass through gaps\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-wave-optics-fig08-2.jpg}
\caption{Double-slit experiment setup (1801)}
\end{figure}

\pause
\textbf{Result:} Vertical light and dark lines spread horizontally
\note{[P0] "Thomas Young, 1801 - proved light is wave"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth,height=0.6\textheight,keepaspectratio]{phys11-wave-optics-fig09-2.jpg}
...
\end{itemize}
\note{[P0] "Light spreads out from each slit"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.55\textheight,keepaspectratio]{phys11-wave-optics-fig11-5.jpg}
...
\note{[P0] "Two waves travel from slits to screen"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.55\textheight,keepaspectratio]{phys11-wave-optics-fig11-4.jpg}
...
\note{[P0] "Graph shows intensity vs angle"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-wave-optics-fig12-2.jpg}
...
\note{[P0] "Single slit different from double slit"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-wave-optics-fig13-2.jpg}
...
\end{block}
\note{[P0] "Ray from center travels lambda over 2 farther than ray from top"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=0.5\textheight,keepaspectratio]{phys11-wave-optics-fig20-5.jpg}
\caption{Light through grating produces sharper pattern than double slit}
\end{figure}
\note{[P0] [THE REVELATION] "Diffraction grating: many slits instead of two"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.65\textheight,keepaspectratio]{phys11-wave-optics-fig20-4.jpg}
\caption{Australian opal and butterfly wings - natural reflection gratings}
\end{figure}
\note{- Opal: rows of reflectors act like grating\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-wave-optics-fig21-2.jpg}
\caption{Intensity comparison: double slit (a) vs grating (b)}
\end{figure}

\pause
\textbf{Key difference:} More slits = narrower, brighter maxima
\note{[P0] "Compare intensity graphs"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-wave-optics-fig22-2.jpg}
...
\end{itemize}
\note{[P0] "CD grooves 1,600 per millimeter - similar to visible wavelengths"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=0.55\textheight,keepaspectratio]{phys11-wave-optics-fig25-2.jpg}
...
\end{itemize}
\note{[P0] "Spectroscope uses grating to separate wavelengths"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-wave-optics-fig26-2.jpg}
...
\end{alertblock}
\note{[P0] [THE REVELATION] "Diffraction unavoidable consequence of wave nature"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.4\textheight,keepaspectratio]{phys11-wave-optics-fig29-2.jpg}
...
\note{[P0] [THE REVELATION] "Lord Rayleigh, 19th century - criterion for resolution"\\\\
