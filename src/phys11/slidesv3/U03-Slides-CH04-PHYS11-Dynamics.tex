...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-dynamics-fig01.jpg}
\end{figure}
...
\end{exampleblock}
\note{[P0] "The dolphin jumping out of water - elegant, beautiful"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.35\textheight,keepaspectratio]{phys11-dynamics-fig02.jpg}
\end{figure}
...
\begin{center}
\includegraphics[width=0.5\textwidth,height=0.4\textheight,keepaspectratio]{phys11-dynamics-fig02.jpg}
\end{center}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-dynamics-fig03.jpg}
\end{figure}
...
\note{[P0] "Box sliding across floor"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.55\textheight,keepaspectratio]{phys11-dynamics-fig04.jpg}
\end{figure}

\pause
Same force, different masses, different accelerations.
\note{[P0] "Boy pushes basketball with same force as car"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-dynamics-fig05.jpg}
\end{figure}
...
\note{[P0] "Swimmer pushes off pool wall"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.35\textheight,keepaspectratio]{phys11-dynamics-fig06.jpg}
\end{figure}
...
\note{[P0] "Person holding mass on rope"\\\\
...
\end{alertblock}
\note{[P0] "Rockets move by expelling gas backward"\\\\
