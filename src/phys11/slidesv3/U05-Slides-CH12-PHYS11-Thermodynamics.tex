...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig01.jpg}
\caption{Steam engine: burning fuel transfers heat to do work}
\end{figure}

\pause
\textbf{The challenge:} Most thermal energy escapes as waste heat.
\note{[P0] "Steam engines revolutionized civilization"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-thermodynamics-fig02.jpg}
...
\note{[P0] [THE CONFLICT] "Why doesn't Earth heat to match sun?"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig03.jpg}
\end{figure}
...
\end{alertblock}
\note{[P0] "Same force applied two ways"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig04.jpg}
\end{figure}

\pause
(a) Volume increases. (b) Pressure increases. (c) Temperature increases.
\note{[P0] "Three stages of pumping air into deflated tire"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-thermodynamics-fig05.jpg}
...
\end{block}
\note{[P0] "When gas expands, it does work"\\\\
...
\note{[P0] [ALGEBRA] "Delta U equals Q minus W"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig06.jpg}
\end{figure}

\vspace{0.3cm}

$Q$ in adds energy. $W$ out removes energy. $\Delta U$ is net change.
\note{- System like bank account\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-thermodynamics-fig07.jpg}
\end{figure}
...
\end{itemize}
\note{[P0] "Your body obeys first law"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig08.jpg}
...
\end{itemize}
\note{[P0] "Ice melting: classic entropy increase"\\\\
...
\end{itemize}
\end{alertblock}
\note{[P0] "Second law - entropy never decreases"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig09.jpg}
\end{figure}
...
\note{[P0] "Heat always flows hot to cold - why?"\\\\
...
\note{[P0] "Can entropy decrease? Yes, locally, with energy input"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig10.jpg}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-thermodynamics-fig11.jpg}
\end{figure}
...
\end{itemize}
\note{[P0] "Heat pumps/fridges: engines backward"\\\\
