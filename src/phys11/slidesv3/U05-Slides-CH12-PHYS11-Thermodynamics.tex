...
\end{center}
Change in \energy{internal energy} equals \heat{heat} added minus \work{work} done by system.
\end{block}
...
Where:
\begin{itemize}
\item $\Delta \energy{U}$ = change in \energy{internal energy}
...
\pressure{P}\volume{V} &= \particles{N}\constant{k}\temp{T} \quad \text{(Ideal gas)} \\
\work{W} &= \pressure{P}\Delta \volume{V} \quad \text{(\pressure{P}-\volume{V} work)} \\
\Delta \energy{U} &= \heat{Q} - \work{W} \quad \text{(First law)} \\
