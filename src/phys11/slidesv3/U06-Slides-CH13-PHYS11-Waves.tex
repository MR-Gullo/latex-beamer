...
\end{itemize}
\note{[P0][Fig 13.5: The wave on a]  "Idealized water wave - sinusoidal pattern"\\\\
...
\end{exampleblock}
\note{[P0] [Fig 13.6: A surfer negotiates a] "Guitar string shows transverse wave pattern"\\\\
...
\end{itemize}
\note{[P0][Fig 13.6: A surfer negotiates a]  "Surfer in California riding massive wave"\\\\
...
\end{itemize}
\end{block}
\note{[P0] [Fig 13.6: A surfer negotiates a] "Three objectives for wave properties"\\\\
...
\end{itemize}
\note{[P0][Fig 13.7: The wave has a]  "Anatomy of idealized water wave"\\\\
...
\end{exampleblock}
\note{[P0][Fig 13.8: Because they travel at]  "Sound system with woofer and tweeter"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-waves-fig13-10.jpg}
\end{figure}
...
\end{itemize}
\note{[P0][Fig 13.10: These waves result from]  "Earthquake damage - palpable evidence of wave energy"\\\\
...
\note{[P0][Fig 13.10: Complex wave pattern from multiple sources] "Real water waves - complex crisscross pattern"\\\\
...
\note{[P0][Fig 13.11: Constructive interference doubles amplitude] "Two identical waves arrive in phase"\\\\
...
\end{alertblock}
\note{[P0][Fig 13.12: Destructive interference creates zero amplitude] "Two identical waves arrive out of phase"\\\\
...
\note{[P0][Fig 13.14: A standing wave is]  "Superposition of dissimilar waves - different amplitudes and wavelengths"\\\\
...
\note{[P0][Fig 13.14: Standing wave from opposite-moving waves] "Standing wave - appears to vibrate in place"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-waves-fig13-16.jpg}
\end{figure}
...
\note{[P0][Fig 13.16: The figure shows a]  "Standing wave on string fixed at both ends"\\\\
...
\note{[P0][Fig 13.18: A wave refracts as]  "Wave on string approaching fixed end"\\\\
...
\note{[P0][Fig 13.18: Wave refracts entering different medium] "Wave entering different medium"\\\\
