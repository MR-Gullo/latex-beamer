...
\end{exampleblock}
\note{[P0][Fig 14.1: This tree fell some]  "Tree fell some time ago"\\\\
...
\note{[P0] [Fig 14.2: A vibrating string moving] "Vibrating string moving to the right"\\\\
...
\end{itemize}
\end{exampleblock}
\note{[P0][Fig 14.3: As the string moves]  "Graph shows gauge pressure vs distance"\\\\
...
\note{[P0][Fig 14.6: When fireworks explode in]  "Sound wave travels up ear canal"\\\\
...
\note{[P0] [Fig 14.6: When fireworks explode in] "Fireworks display"\\\\
...
\note{[P0] [Fig 14.7: A sound wave emanates] "Sound wave emanating from source"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-sound-fig14-7.jpg}
\end{figure}
...
\end{exampleblock}
\note{[P0][Fig 14.7: A sound wave emanates]  "Crowded roadway in Delhi - hard to hear without shouting"\\\\
...
\note{[P0][Fig 14.7: A sound wave emanates]  [THE REVELATION] "Intensity is power per area"\\\\
...
\note{[P0] [Fig 14.10: Graphs of the pressures] "Two sound waves with different intensities"\\\\
...
\note{[P0] [Fig 14.11: The illustration shows the] "Anatomy of the ear"\\\\
...
\note{[P0] [Fig 14.14: Sounds emitted by a] "Sound emitted by stationary source"\\\\
...
\note{[P0] [Fig 14.15: Sounds emitted by a] "Source moving to the right"\\\\
...
\note{[P0][Fig 14.15: Doppler compression from moving source] "Sonic boom from aircraft"\\\\
...
\note{[P0] [Fig 14.18: The paddle ball on] "Paddle ball on elastic band"\\\\
...
\note{[P0][Fig 14.10: Sound wave pressure graphs] "Superposition of two slightly different frequencies"\\\\
...
\note{[P0] [Fig 14.23: Resonance of air in] "Tube closed at one end"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-sound-fig14-13.jpg}
\end{figure}
...
Only odd harmonics!
\note{[P0][Fig 14.13: Playing music, also known]  "Fundamental and first three overtones"\\\\
...
All harmonics!
\note{[P0] [Fig 14.27: The resonant frequencies of] "Tube open at both ends"\\\\
