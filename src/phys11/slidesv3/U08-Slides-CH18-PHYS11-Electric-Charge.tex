...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-electric-charge-fig01.jpg}
\end{figure}

\pause
\textit{What invisible force makes strands of hair repel each other?}

\note{[P0] "Look at this child's hair - what's happening?"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.55\textheight,keepaspectratio]{phys11-electric-charge-fig05.jpg}
\end{figure}

\pause
\textbf{Pattern:} Glass rods repel each other. Silk cloths repel each other. Glass attracts silk.

\note{[P0] "Three experiments showing charge behavior"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-electric-charge-fig07.jpg}
\end{figure}

\pause
Rutherford's model: electrons orbit a tiny, dense nucleus of protons.

\note{[P0] "Thomson's plum pudding model vs Rutherford's nuclear model"\\\\
...
\end{center}
The fundamental unit of electric charge (magnitude).
\end{block}
...
\textbf{The carriers:}
\begin{itemize}
\item Proton charge: $+e = +1.602 \times 10^{-19}$ C \pause
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-electric-charge-fig08.jpg}
\end{figure}
...
\note{[P0] "Millikan oil-drop experiment - classic physics"\\\\
...
\textbf{Discovery:} Charge always comes in multiples of $e$
...
\Large $\boxed{Q = ne}$
\end{center}
where $n$ is an integer ($\pm 1, \pm 2, \pm 3, \ldots$)
\end{block}
...
\begin{center}
\Large $\boxed{q_{\text{initial}} = q_{\text{final}}}$
\end{center}
...
\begin{itemize}
\item Total charge before interaction = total charge after \pause
\item Charge can move, but net charge stays constant \pause
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.55\textheight,keepaspectratio]{phys11-electric-charge-fig14-1.jpg}
\end{figure}

\pause
\textbf{Semiconductors:} Between conductors and insulators (silicon, germanium)

\note{[P0] "Spectrum of conductivity from best conductors to best insulators"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-electric-charge-fig14.jpg}
\end{figure}

\pause
\textbf{Conductor:} Charge spreads to outer surface (repulsion wins).\\
\textbf{Insulator:} Charge stays in place (can't move).

\note{[P0] "How charge distributes on different materials"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-electric-charge-fig16.jpg}
\end{figure}
...
\note{[P0] "Charging by conduction - electrons flow through touch"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.6\textheight,keepaspectratio]{phys11-electric-charge-fig18.jpg}
\end{figure}

\pause
\textbf{Induction:} Creating charge separation by approaching a charged object (no touching!)

\note{[P0] "Four-step process for charging by induction"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-electric-charge-fig19.jpg}
\end{figure}
...
\note{[P0] "Van de Graaff generator - classic demo device"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.5\textheight,keepaspectratio]{phys11-electric-charge-fig20.jpg}
\end{figure}
...
\note{[P0] "Man touching Van de Graaff - hair standing on end"\\\\
...
\textbf{Given:}
\begin{itemize}
\item Blue sphere initial: $q_1 = +4$ C
\item Red sphere initial: $q_2 = +8$ C
\item Blue sphere final: $q_1' = +10$ C
\end{itemize}

\textbf{Find:} Final charge on red sphere $q_2'$
...
\textbf{Law:} $q_{\text{initial}} = q_{\text{final}}$

\pause
\vspace{0.2cm}

\textbf{Step 1:} Find total initial charge
$$q_{\text{initial}} = +4\text{ C} + 8\text{ C} = +12\text{ C}$$

\pause
\vspace{0.2cm}

\textbf{Step 2:} Apply conservation law
$$q_{\text{final}} = +10\text{ C} + q_2'$$

\pause
\vspace{0.2cm}

\textbf{Step 3:} Solve for $q_2'$
$$+12\text{ C} = +10\text{ C} + q_2'$$
$$\boxed{q_2' = +2\text{ C}}$$

\pause
\textbf{Check:} $12 = 10 + 2$ \checkmark Charge is conserved!
...
\begin{exampleblock}{The Challenge (3 min, silent)}
An ink droplet in a printer has net charge $q = -1.0 \times 10^{-10}$ C after passing through an electron beam.

\vspace{0.3cm}

\textbf{Given:}
\begin{itemize}
\item Droplet charge: $q = -1.0 \times 10^{-10}$ C
\item Electron charge: $e = -1.602 \times 10^{-19}$ C
\end{itemize}
...
\begin{enumerate}
\item What equation relates total charge to number of electrons?
...
\textbf{Equation:} $Q = ne$, so $n = \frac{Q}{e}$

\pause
\vspace{0.2cm}

\textbf{Substitute:}
$$n = \frac{q}{q_{e^-}} = \frac{-1.0 \times 10^{-10}\text{ C}}{-1.602 \times 10^{-19}\text{ C}}$$

\pause
\vspace{0.2cm}

\textbf{Simplify:}
$$n = \frac{1.0 \times 10^{-10}}{1.602 \times 10^{-19}} = 6.24 \times 10^{8}$$

\pause
\vspace{0.2cm}

$$\boxed{n = 6 \times 10^{8} \text{ electrons}}$$
...
\begin{enumerate}
\item Two types of charge: positive (protons) and negative (electrons) \pause
\item Fundamental charge: $e = 1.602 \times 10^{-19}$ C \pause
\item Charge quantization: $Q = ne$ (only integer multiples) \pause
\item Conservation: $q_{\text{initial}} = q_{\text{final}}$ (never violated) \pause
\item Conductors let charge move; insulators don't \pause
...
\begin{align}
e &= 1.602 \times 10^{-19}\text{ C} && \text{(fundamental charge)} \\
Q &= ne && \text{(charge quantization)} \\
q_{\text{initial}} &= q_{\text{final}} && \text{(conservation of charge)}
\end{align}
