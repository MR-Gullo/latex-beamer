...
\note{[P0][Fig 18.1: This child's hair contains]  "Look at this child's hair - what's happening?"\\\\
...
\note{[P0][Fig 18.2: A glass rod becomes]  "Three experiments showing charge behavior"\\\\
...
\note{[P0][Fig 18.3: The left drawing shows]  "Thomson's plum pudding model vs Rutherford's nuclear model"\\\\
...
\note{[P0][Fig 18.4: The oil-drop experiment involved]  "Millikan oil-drop experiment - classic physics"\\\\
...
\note{[P0][Fig 18.10: In the top row]  "How charge distributes on different materials"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-electric-charge-fig18-16.jpg}
\end{figure}
...
\note{[P0] [Fig 18.16: The magnitude of the] "Charging by conduction - electrons flow through touch"\\\\
...
\note{[P0][Fig 18.11: (a) Two neutral conducting]  "Four-step process for charging by induction"\\\\
...
\note{[P0][Fig 18.12: Van de Graaff generators]  "Van de Graaff generator - classic demo device"\\\\
...
\note{[P0][Fig 18.13: The man touching the]  "Man touching Van de Graaff - hair standing on end"\\\\
