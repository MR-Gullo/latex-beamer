...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-work-energy-fig9-1.jpg}
...
\note{[P0] [Fig 9.1: Roller coaster loop] "Roller coaster - pure physics playground"\\\\
...
\begin{center}
\Large $\boxed{\work{W} = \force{F}\disp{d}}$
\end{center}
\work{Work} equals \force{force} times \disp{distance} moved in the direction of the \force{force}.
\end{block}
...
\work{Work} requires TWO things: \force{force} AND motion in the direction of \force{force}.
\end{exampleblock}
...
\textbf{Two forms of mechanical \energy{energy}:}

\pause
\vspace{0.3cm}

\begin{block}{\kenergy{Kinetic Energy} (KE)}
\energy{Energy} of motion. A moving object has \kenergy{kinetic energy}.
\end{block}

\pause

\begin{block}{\penergy{Potential Energy} (PE)}
Stored \energy{energy}. Gravitational \penergy{PE} is \energy{energy} an object has due to its position above Earth's surface.
\end{block}

\pause
\vspace{0.3cm}
Both measured in joules (J), same unit as \work{work}.
...
Lift a rock off the ground. You exert \force{force} upward over \disp{distance}.

\pause
\vspace{0.3cm}

The \force{force} equals the rock's \force{weight}: $\force{F} = \force{w} = \mass{m}\grav{g}$

\pause

\work{Work} done equals \force{force} times \disp{distance}:

\begin{block}{Gravitational \penergy{Potential Energy}}
\begin{center}
\Large $\boxed{\penergy{PE} = \mass{m}\grav{g}\disp{h}}$
\end{center}
\penergy{Potential energy} equals \mass{mass} times \grav{gravity} times \disp{height}.
\end{block}
...
Drop the rock. Gravity does \work{work} on it. Rock speeds up.

\pause
\vspace{0.3cm}

\begin{block}{\kenergy{Kinetic Energy}}
\begin{center}
\Large $\boxed{\kenergy{KE} = \frac{1}{2}\mass{m}\vel{v}^2}$
\end{center}
\kenergy{Kinetic energy} equals one-half \mass{mass} times \vel{velocity} squared.
\end{block}
...
\begin{exampleblock}{The Mental Model}
Heavier objects and faster objects have more \kenergy{KE}. \vel{Velocity} matters more because it's squared.
\end{exampleblock}
...
\begin{center}
\Large $\boxed{\work{W} = \Delta \kenergy{KE} = \frac{1}{2}\mass{m}\vel{v}_2^2 - \frac{1}{2}\mass{m}\vel{v}_1^2}$
\end{center}
Net \work{work} equals change in \kenergy{kinetic energy}.
\end{block}

\pause
\vspace{0.3cm}

When you do \work{work} on an object, you change its \kenergy{kinetic energy}.
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.4\textheight,keepaspectratio]{phys11-work-energy-fig9-2.jpg}
...
\note{[P0] [Fig 9.2: James Joule portrait] "James Joule - English physicist"\\\\
...
\work{Work} tells you how much. \power{Power} tells you how fast.

\pause

\begin{block}{\power{Power}}
\begin{center}
\Large $\boxed{\power{P} = \frac{\work{W}}{\tvar{t}}}$
\end{center}
\power{Power} equals \work{work} divided by \tvar{time}.
\end{block}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-work-energy-fig9-3.jpg}
\caption{Two ways to move a TV to the fourth floor}
\end{figure}

\pause
\textbf{Same \work{work}. Different \power{power}.}

Pulley (2 min) generates more \power{power} than stairs (5 min).
\note{[P0] [Fig 9.3: TV stairs vs pulley] "Two ways to move TV to fourth floor"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-work-energy-fig9-4.jpg}
\caption{James Watt (1736-1819) - The unit of power}
\end{figure}
...
\note{[P0] [Fig 9.4: James Watt portrait] "James Watt - Scottish engineer"\\\\
...
\textbf{Equation:} $\work{W} = \Delta \kenergy{KE} = \frac{1}{2}\mass{m}\vel{v}_2^2 - \frac{1}{2}\mass{m}\vel{v}_1^2$

\pause

\textbf{Factor out:} $\work{W} = \frac{1}{2}\mass{m}(\vel{v}_2^2 - \vel{v}_1^2)$

\pause

\textbf{Substitute:} $\work{W} = \frac{1}{2}(50)(12^2 - 8^2)$

\pause

$\work{W} = 25(144 - 64) = 25(80)$

\pause

$$\boxed{\work{W} = 2000 \text{ J}}$$

\pause
\textbf{Check:} \energy{Energy} increased because friend did \work{work}. Reasonable!
...
\begin{center}
\Large \energy{Energy} is never created or destroyed.\\[0.3cm]
...
\begin{block}{The Law of Conservation of \energy{Energy}}
In a closed system, total \energy{energy} remains constant.
\end{block}
...
\textbf{Civilian:} "The ball lost \energy{energy} when it stopped bouncing."\\
\textbf{Physicist:} "\energy{Energy} transformed to heat from friction and sound."
\end{alertblock}
...
Lift a rock to the top. You do \work{work}. Rock gains \penergy{PE}.

\pause

Release the rock. \penergy{PE} converts to \kenergy{KE} as it falls.

\pause

Hit the ground. \kenergy{KE} converts to heat and sound.

\pause
\vspace{0.3cm}

\begin{exampleblock}{The Mental Model}
\energy{Energy} changes form constantly. The total amount stays the same.
\end{exampleblock}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-work-energy-fig9-6.jpg}
\caption{Energy transformations on a roller coaster}
\end{figure}

\pause
\textbf{Top:} High \penergy{PE}, low \kenergy{KE} (slow)

\pause
\textbf{Bottom:} Low \penergy{PE}, high \kenergy{KE} (fast)

\pause
\textbf{Next hill:} \kenergy{KE} converts back to \penergy{PE}
\note{[P0] [Fig 9.6: Roller coaster hill] "Roller coaster - energy transformation in action"\\\\
...
Assume no \energy{energy} lost to friction.

\pause

\begin{block}{Conservation of Mechanical \energy{Energy}}
\begin{center}
\Large $\boxed{\kenergy{KE}_1 + \penergy{PE}_1 = \kenergy{KE}_2 + \penergy{PE}_2}$
\end{center}
Initial \kenergy{kinetic} plus initial \penergy{potential} equals final \kenergy{kinetic} plus final \penergy{potential}.
\end{block}

\pause
\vspace{0.3cm}

Either side equals total mechanical \energy{energy}.

\pause

\textbf{Closed system:} No \energy{energy} lost to surroundings.
...
\begin{align*}
\kenergy{KE} &= \frac{1}{2}\mass{m}\vel{v}^2 \\
\penergy{PE} &= \mass{m}\grav{g}\disp{h} \\
\kenergy{KE}_1 + \penergy{PE}_1 &= \kenergy{KE}_2 + \penergy{PE}_2
\end{align*}
...
Combining them:
$$\frac{1}{2}\mass{m}\vel{v}_1^2 + \mass{m}\grav{g}\disp{h}_1 = \frac{1}{2}\mass{m}\vel{v}_2^2 + \mass{m}\grav{g}\disp{h}_2$$

\pause
\vspace{0.3cm}

\textbf{Pro tip:} \mass{Mass} often cancels out!
...
\textbf{Initial \energy{energy}:} $\kenergy{KE}_1 = 0$ (at rest), $\penergy{PE}_1 = \mass{m}\grav{g}\disp{h}_1 = 10 \times 9.8 \times 20 = 1960$ J

\pause

\textbf{At 10 m \disp{height}:} $\penergy{PE}_2 = \mass{m}\grav{g}\disp{h}_2 = 10 \times 9.8 \times 10 = 980$ J

\pause

\textbf{Conservation:} $\kenergy{KE}_1 + \penergy{PE}_1 = \kenergy{KE}_2 + \penergy{PE}_2$

\pause

$0 + 1960 = \kenergy{KE}_2 + 980$

\pause

$$\boxed{\kenergy{KE}_2 = 980 \text{ J}}$$

\pause

\textbf{Check:} Lost 980 J of \penergy{PE}, gained 980 J of \kenergy{KE}. \energy{Energy} conserved!
...
Total mechanical \energy{energy} at any point equals \energy{energy} at start.

\pause
\vspace{0.3cm}

At the top of roller coaster: mostly \penergy{PE}, little \kenergy{KE}

\pause

At the bottom: mostly \kenergy{KE}, little \penergy{PE}

\pause

At any point in between: \penergy{PE} + \kenergy{KE} = constant

\pause
\vspace{0.3cm}

\begin{alertblock}{The Paradox}
\textbf{Your brain says:} "The roller coaster is slowing down, losing \energy{energy}."\\
\textbf{Reality:} "\kenergy{KE} converting to \penergy{PE}. Total \energy{energy} unchanged."
\end{alertblock}
...
\textbf{Ideal system:} No friction, \energy{energy} perfectly conserved

\pause

\textbf{Real system:} Friction converts mechanical \energy{energy} to heat

\pause
\vspace{0.3cm}

\begin{exampleblock}{The Mental Model}
Friction is not a violation of conservation. Heat is still \energy{energy}, just less useful.
\end{exampleblock}
...
\textbf{Closed system:} No \energy{energy} enters or leaves
...
\begin{enumerate}
\item \work{Work} = \force{force} times \disp{distance} (only if motion happens) \pause
\item \work{Work} changes \energy{energy} (work-energy theorem) \pause
\item \energy{Energy} has two forms: \kenergy{kinetic} (motion) and \penergy{potential} (stored) \pause
\item \power{Power} = rate of doing \work{work} \pause
\item \energy{Energy} is conserved: \kenergy{KE} + \penergy{PE} = constant \pause
\item \energy{Energy} transforms but never vanishes
\end{enumerate}
\end{block}
...
\begin{align*}
\work{W} &= \force{F}\disp{d} \\
\kenergy{KE} &= \frac{1}{2}\mass{m}\vel{v}^2 \\
\penergy{PE} &= \mass{m}\grav{g}\disp{h} \\
\work{W} &= \Delta \kenergy{KE} = \frac{1}{2}\mass{m}\vel{v}_2^2 - \frac{1}{2}\mass{m}\vel{v}_1^2 \\
\power{P} &= \frac{\work{W}}{\tvar{t}} \\
\kenergy{KE}_1 + \penergy{PE}_1 &= \kenergy{KE}_2 + \penergy{PE}_2
\end{align*}
