...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig01.jpg}
...
\note{[P0] "Are clouds a useful reference frame?"\\\\
...
\begin{center}
\includegraphics[width=0.5\textwidth,height=0.4\textheight,keepaspectratio]{phys11-kinematics-fig04.jpg}
...
\note{[P0] "Galileo - one of the first to explore reference frames"\\\\
...
\note{[P0] "Visual representation of distance vs displacement"\\\\
...
\note{[P0] "Classic example: drive to school and back"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=0.45\textheight,keepaspectratio]{phys11-kinematics-fig18.jpg}
...
\note{[P0] "Real-world consequence of unit mistakes"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-kinematics-fig24.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.4\textheight,keepaspectratio]{phys11-kinematics-fig26.jpg}
\caption{Airplane passenger velocity at different segments}
\end{figure}

\pause
If velocity is constant, instantaneous = average.
\note{[P0] "Two types of velocity, like speed"\\\\
