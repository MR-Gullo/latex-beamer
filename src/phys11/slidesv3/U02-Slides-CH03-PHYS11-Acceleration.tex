...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-acceleration-fig01.jpg}
...
\end{alertblock}
\note{[P0] "Plane landing at St. Maarten - velocity decreasing"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-acceleration-fig02.jpg}
...
\end{itemize}
\note{[P0] "Two scenarios with vector arrows"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-acceleration-fig03.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-acceleration-fig04.jpg}
...
\note{[P0] "Graph of velocity vs time"\\\\
