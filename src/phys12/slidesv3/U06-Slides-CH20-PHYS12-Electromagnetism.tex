...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys11-magnetism-fig20-1.jpg}
    \end{figure}
    ...
    \note{[Fig 20.1: Aurora Borealis] "Use as visual hook - students recognize phenomenon but not physics"\\\\
    [P0] [THE HOOK] "Aurora Borealis - one of nature's most spectacular shows"\\\\
...
\begin{frame}
    ...
    \begin{block}{Nature's Rule for Moving Charges}
        \begin{center}
            \Large $\boxed{\force{F} = \charge{q}\vel{v}\pConst{B} \sin \theta}$
        \end{center}
        \force{Force} on a \charge{charge} moving through a magnetic field.
    \end{block}
    ...
    \begin{itemize}
        ...
        \item $\charge{q}$ = \charge{charge} (C)
        \item $\vel{v}$ = \vel{velocity} (m/s)
        \item $\pConst{B}$ = magnetic field strength (T, tesla)
        \item $\theta$ = angle between $\vec{\vel{v}}$ and $\vec{\pConst{B}}$
    \end{itemize}
...
\begin{frame}
    ...
    \textbf{To find \force{force} direction on positive \charge{charge}:}
    \begin{enumerate}
        \item Point fingers in direction of \vel{velocity} $\vec{\vel{v}}$ \pause
        \item Curl fingers toward magnetic field $\vec{\pConst{B}}$ \pause
        \item Thumb points in direction of \force{force} $\vec{\force{F}}$
    \end{enumerate}
    ...
    \begin{exampleblock}{Key Insight}
        For negative \charge{charges}, \force{force} is OPPOSITE the thumb direction.
    \end{exampleblock}
...
\begin{frame}
    ...
    \begin{alertblock}{When is \force{Force} Maximum?}
    ...
    \textbf{Maximum \force{force}:} $\force{F}_{\text{max}} = \charge{q}\vel{v}\pConst{B}$ (when $\vel{v} \perp \pConst{B}$)

    \pause
    \vspace{0.3cm}

    \textbf{Zero \force{force}:} $\force{F} = 0$ (when $\vel{v} \parallel \pConst{B}$, $\theta = 0°$ or $180°$)

    \pause
    \vspace{0.3cm}

    \begin{exampleblock}{The Mental Model}
        \charge{Charge} moving parallel to field lines feels no \force{force}. Moving perpendicular to field lines feels maximum \force{force}.
    \end{exampleblock}
...
\begin{frame}
    ...
    \begin{block}{Universal Law: Magnetic Force on Wire}
        \begin{center}
            \Large $\boxed{\force{F} = \current{I} \disp{\ell} \pConst{B} \sin \theta}$
        \end{center}
        \vspace{0.2cm}
        \current{Current}-carrying wire in magnetic field experiences \force{force}.
    \end{block}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-magnetism-fig20-23.jpg}
    \end{figure}
    ...
    \begin{alertblock}{The Paradox}
        ...
        \textbf{Physicist:} "Just a \current{current} loop in a magnetic field."
    \end{alertblock}

    \note{[Fig 20.23: Electric motor schematic] "Point out shaft, loop, magnetic field vectors - simplify before complicating"\\\\
    [P0] "Schematic of simple DC motor"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth,height=0.4\textheight,keepaspectratio]{phys11-magnetism-fig20-24.jpg}
    \end{figure}

    \pause

    \begin{block}{Universal Law: \torque{Torque} on \current{Current} Loop}
        \begin{center}
            \Large $\boxed{\torque{\tau} = \particles{N}\current{I}\area{A}\pConst{B} \sin \theta}$
        \end{center}
        Where $\particles{N}$ = turns, $\current{I}$ = \current{current}, $\area{A}$ = loop \area{area}, $\pConst{B}$ = magnetic field
    \end{block}

    \note{[Fig 20.24: Top view of wire loop] "Trace force vectors from previous schematic - connect 3D to 2D view"\\\\
    [P0] "Top view shows forces on vertical wire segments"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth,height=0.45\textheight,keepaspectratio]{phys11-magnetism-fig20-25.jpg}
    \end{figure}

    \pause

    \begin{alertblock}{The Problem}
        \torque{Torque} reverses every half turn. Without \textbf{brushes} to reverse \current{current}, motor oscillates instead of rotating.
    \end{alertblock}

    \note{[Fig 20.25: Torque vs angle, brushes reversing current] "Show both parts (a) and (b) - diagram explains what equation predicts"\\\\
    [P0] "The torque problem"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.65\textwidth,height=0.45\textheight,keepaspectratio]{phys11-magnetism-fig20-26.jpg}
    \end{figure}

    \pause

    \begin{exampleblock}{The Symmetry}
        \textbf{Motor:} Electrical \energy{energy} $\rightarrow$ Mechanical \energy{energy}\\
        \textbf{Generator:} Mechanical \energy{energy} $\rightarrow$ Electrical \energy{energy}
    \end{exampleblock}

    \note{[Fig 20.26: Generator schematic] "Compare directly to motor figure - emphasize identical structure, reversed energy flow"\\\\
    [P0] "Motor physics reversed"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth,height=0.3\textheight,keepaspectratio]{phys11-magnetism-fig20-27.jpg}
    \end{figure}
    ...
    \begin{block}{Universal Law: Generator EMF}
        \begin{center}
            \Large $\boxed{\voltage{\varepsilon} = \particles{N}\area{A}\pConst{B}\angvel{\omega} \sin \angvel{\omega} \tvar{t}}$
        \end{center}
        Peak emf: $\voltage{\varepsilon_0} = \particles{N}\area{A}\pConst{B}\angvel{\omega}$
    \end{block}

    \note{[Fig 20.27: EMF in straight wire through B field] "Isolate single wire first - show velocity decomposition before full coil"\\\\
    [P0] "Deriving generator output"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys11-magnetism-fig20-28.jpg}
    \end{figure}
    ...
    \note{[Fig 20.28: Generator with bulb and EMF graph] "Connect equation to visual output - sine function becomes reality"\\\\
    [P0] "Generator connected to light bulb"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth,height=0.55\textheight,keepaspectratio]{phys11-magnetism-fig20-29.jpg}
    \end{figure}
    ...
    \note{[Fig 20.29: Steam turbine cutaway] "Real engineering - bridge abstraction to reality, emphasize scale"\\\\
    [P0] "Cutaway of steam turbine generator"\\\\
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{phys11-magnetism-fig20-30.jpg}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \pause
            \begin{block}{What Transformers Do}
                Change AC \voltage{voltage} from one value to another\\
                \vspace{0.2cm}
    ...
    \note{[Fig 20.30: Laminated and toroidal transformers] "Show physical devices before explaining mechanism - concrete before abstract"\\\\
    [P0] "Two types shown"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.65\textwidth,height=0.45\textheight,keepaspectratio]{phys11-magnetism-fig20-31.jpg}
    \end{figure}
    ...
    \begin{block}{The Principle}
        \begin{enumerate}
            \item AC \current{current} in primary coil creates changing magnetic field
            \item Iron core traps and amplifies magnetic field
            \item Changing field passes through secondary coil
            \item Induces AC \voltage{voltage} in secondary coil
        \end{enumerate}
    \end{block}

    \note{[Fig 20.31: Simple transformer schematic] "Trace flux path through core - predict Faraday's law application before revealing"\\\\
    [P0] "Transformer construction"\\\\
...
\begin{frame}
    ...
    \begin{block}{Universal Law: \voltage{Voltage} Transformation}
        \begin{center}
            \Large $\boxed{\frac{\voltage{V_S}}{\voltage{V_P}} = \frac{\particles{N_S}}{\particles{N_P}}}$
        \end{center}
        \vspace{0.2cm}
        Secondary \voltage{voltage} / Primary \voltage{voltage} = Turns ratio
    \end{block}

    \pause

    \begin{exampleblock}{Step-Up vs. Step-Down}
        \textbf{Step-Up:} $\particles{N_S} > \particles{N_P}$ $\rightarrow$ Increases \voltage{voltage} (power transmission)\\
        \textbf{Step-Down:} $\particles{N_S} < \particles{N_P}$ $\rightarrow$ Decreases \voltage{voltage} (home delivery)
    \end{exampleblock}
...
\begin{frame}
    ...
    \begin{block}{\power{Power} Transmitted}
        $$\power{P}_{\text{transmitted}} = \current{I}_{\text{transmitted}} \voltage{V}_{\text{transmitted}}$$
    \end{block}

    \pause

    \begin{alertblock}{The Problem: Joule Losses}
        $$\power{P}_{\text{lost}} = \current{I}_{\text{transmitted}}^2 \resist{R}_{\text{wire}}$$
        \power{Power} lost as heat proportional to \textbf{\current{current} squared}
    \end{alertblock}

    \pause

    \begin{exampleblock}{The Solution}
        Increase \voltage{voltage} $\rightarrow$ Decrease \current{current} $\rightarrow$ Minimize losses
    \end{exampleblock}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.65\textheight,keepaspectratio]{phys11-magnetism-fig20-32.jpg}
    \end{figure}

    \note{[Fig 20.32: Electric grid from plant to home] "Trace voltage levels left to right - quantify transformer equation applications"\\\\
    [P0] "Journey of electricity from plant to home"\\\\
...
\begin{frame}
    ...
    \begin{block}{We Already Know}
        Electric \current{current} creates magnetic field (electromagnet)
    \end{block}

    \pause

    \begin{block}{Faraday's Question (1831)}
        Can magnetic field create electric \current{current}?
    \end{block}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth,height=0.6\textheight,keepaspectratio]{phys11-magnetism-fig20-33.jpg}
    \end{figure}

    \note{[Fig 20.33: Magnet and coil with ammeter] "Walk through all four panels - predict current before revealing each"\\\\
    [P0] "Simple but revolutionary experiment"\\\\
...
\begin{frame}
    ...
    \begin{alertblock}{Terrible Name}
        \textbf{Electromotive Force} is NOT a \force{force}\\
        It's a \textit{\voltage{potential difference}} (\voltage{voltage})
    \end{alertblock}
    ...
    \begin{block}{Universal Law: EMF Definition}
        \begin{center}
            \energy{Energy} added per unit \charge{charge} by source\\
            \vspace{0.2cm}
            Symbol: $\voltage{\varepsilon}$ \quad Units: Volts (V)
        \end{center}
    \end{block}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.65\textwidth,height=0.4\textheight,keepaspectratio]{phys11-magnetism-fig20-34.jpg}
    \end{figure}
    ...
    \begin{block}{Universal Law: Magnetic Flux}
        \begin{center}
            \Large $\boxed{\pSpace{\Phi} = \pConst{B}\area{A} \cos \theta}$
        \end{center}
        \vspace{0.2cm}
        Number of field lines perpendicular through \area{area} $\area{A}$\\
        Unit: Weber (Wb) = T$\cdot$m$^2$ = V$\cdot$s
    \end{block}

    \note{[Fig 20.34: Field lines through loop changing] "Count lines explicitly in both panels - quantify abstraction"\\\\
    [P0] "What creates EMF?"\\\\
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth,height=0.5\textheight,keepaspectratio]{phys11-magnetism-fig20-35.jpg}
    \end{figure}
    ...
    \begin{exampleblock}{The Sail Analogy}
        ...
        Maximum \pSpace{flux} when perpendicular ($\theta = 0°$)\\
        Zero \pSpace{flux} when parallel ($\theta = 90°$)
    \end{exampleblock}

    \note{[Fig 20.35: Loop rotation through B field] "Rotate mentally between extremes - connect cos theta to visualization"\\\\
    [P0] "Angle matters"\\\\
...
\begin{frame}
    ...
    \begin{block}{Universal Law: Faraday's Law}
        \begin{center}
            \Large $\boxed{\voltage{\varepsilon} = -\particles{N} \frac{\Delta \pSpace{\Phi}}{\Delta \tvar{t}}}$
        \end{center}
        \vspace{0.2cm}
        EMF induced equals rate of change of magnetic \pSpace{flux}
    \end{block}
    ...
    \begin{exampleblock}{Three Ways to Induce EMF}
        \begin{enumerate}
            \item Change magnetic field strength $\pConst{B}$
            \item Change loop \area{area} $\area{A}$
...
\begin{frame}
    ...
    \begin{block}{Universal Law: Lenz's Law}
        Induced \current{current} flows in direction that \textit{opposes} the change in \pSpace{flux}
    \end{block}

    \pause

    \begin{alertblock}{Nature Resists Change}
        \pSpace{Flux} increasing? $\rightarrow$ Induced field opposes increase\\
        \pSpace{Flux} decreasing? $\rightarrow$ Induced field opposes decrease
    \end{alertblock}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,height=0.65\textheight,keepaspectratio]{phys11-magnetism-fig20-36.jpg}
    \end{figure}

    \note{[Fig 20.36: Bar magnet with pickup coil, three scenarios] "Work through each panel with class prediction - Lenz before right-hand rule"\\\\
    [P0] "Three scenarios with right-hand rule"\\\\
...
\begin{frame}
    ...
    \textbf{Given:}
    \begin{itemize}
        \item $\particles{N} = 16$ turns
        \item $\disp{d} = 0.020$ m
        \item $\Delta \pConst{B} = -0.010$ T
        \item $\Delta \tvar{t} = 34$ s
        \item $\resist{R} = 0.1$ $\Omega$
    \end{itemize}

    \textbf{Find:} Magnitude and direction of induced \current{current}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item How did you calculate the magnetic \pSpace{flux}?
        \item How did you find \current{current} from EMF?
        \item What direction does \current{current} flow?
    \end{enumerate}
...
\begin{frame}
    ...
    \textbf{U - Unknown:} $\current{I} = ?$

    \pause

    \textbf{E - Equations:}
    \begin{align*}
        \voltage{\varepsilon} &= -\particles{N} \frac{\Delta \pSpace{\Phi}}{\Delta \tvar{t}} = -\particles{N} \frac{\Delta \pConst{B} \pi \disp{d}^2}{4 \Delta \tvar{t}}\\
        \current{I} &= \frac{\voltage{\varepsilon}}{\resist{R}}
    \end{align*}

    \pause

    \textbf{S - Substitute:}
    $$\current{I} = -16 \frac{(-0.010\text{ T}) \pi (0.020\text{ m})^2}{4(0.10\, \Omega)(34\text{ s})} = 15\, \mu\text{A}$$

    \pause

    \textbf{S - Statement:} $\boxed{\current{I} = 15\, \mu\text{A}}$ to the right (opposes decrease in field)
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth,height=0.25\textheight,keepaspectratio]{phys11-magnetism-fig20-38.jpg}
    \end{figure}

    \textbf{Given:} $\pConst{B} = 0.010$ T, $\vel{v} = 0.50$ m/s, $\disp{\ell} = 0.10$ m, $\resist{R} = 20\, \Omega$

    \textbf{Find:} \current{Current} magnitude and direction

    \vspace{0.2cm}

    \textit{Work individually. It's okay to get stuck.}

    \note{[Fig 20.38: Slider circuit with U-shaped wire] "Emphasize changing area mechanism - different from previous examples"\\\\
    [THE CHALLENGE] "Rod slides, area changes, flux changes, current flows"\\\\
    [TIMING] 3-4 min SILENT work\\\\
...
\begin{frame}
    ...
    \begin{enumerate}
        \item What changes: $\pConst{B}$, $\area{A}$, or $\theta$?
        \item How fast does \area{area} change?
        \item What's the rate of \pSpace{flux} change?
        \item Direction of induced \current{current}?
    \end{enumerate}
...
\begin{frame}
    ...
    \textbf{E - Equation:}
    $$\frac{\Delta \pSpace{\Phi}}{\Delta \tvar{t}} = \pConst{B} \frac{\Delta \area{A}}{\Delta \tvar{t}} = \pConst{B} \vel{v} \disp{\ell}$$

    \pause

    $$\voltage{\varepsilon} = -\pConst{B} \vel{v} \disp{\ell}$$

    \pause

    \textbf{S - Substitute:}
    $$\current{I} = \frac{\voltage{\varepsilon}}{\resist{R}} = \frac{\pConst{B} \vel{v} \disp{\ell}}{\resist{R}} = \frac{(0.010\text{ T})(0.50\text{ m/s})(0.10\text{ m})}{20\,\Omega}$$

    \pause

    $$\boxed{\current{I} = 25\,\mu\text{A}}$$ flowing \textbf{clockwise}

    \pause

    \textbf{Check:} Lenz's law - \pSpace{flux} into page increasing, so induced field out of page (\current{current} is clockwise)
...
\begin{frame}
    ...
    \begin{block}{Motors and Generators}
        \begin{align*}
            \force{F} &= \current{I}\disp{\ell} \pConst{B} \sin\theta \quad \text{(\force{Force} on wire)}\\
            \torque{\tau} &= \particles{N}\current{I}\area{A}\pConst{B}\sin\theta \quad \text{(Motor \torque{torque})}\\
            \voltage{\varepsilon} &= \particles{N}\area{A}\pConst{B}\angvel{\omega}\sin\angvel{\omega} \tvar{t} \quad \text{(Generator EMF)}
        \end{align*}
    \end{block}

    \begin{block}{Transformers and \power{Power}}
        \begin{align*}
            \frac{\voltage{V_S}}{\voltage{V_P}} &= \frac{\particles{N_S}}{\particles{N_P}} \quad \text{(Transformer equation)}\\
            \power{P}_{\text{lost}} &= \current{I}^2 \resist{R} \quad \text{(Joule heating)}
        \end{align*}
    \end{block}
...
\begin{frame}[shrink]
    ...
    \begin{block}{Electromagnetic Induction}
        \begin{align*}
            \pSpace{\Phi} &= \pConst{B}\area{A}\cos\theta \quad \text{(Magnetic \pSpace{flux})}\\
            \voltage{\varepsilon} &= -\particles{N}\frac{\Delta\pSpace{\Phi}}{\Delta \tvar{t}} \quad \text{(Faraday's Law)}\\
            \voltage{\varepsilon} &= \pConst{B}\disp{\ell} \vel{v} \quad \text{(Motional EMF)}
        \end{align*}
    \end{block}
    ...
    \begin{exampleblock}{Lenz's Law (Direction)}
        Induced \current{current} opposes the change in magnetic \pSpace{flux}
    \end{exampleblock}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Electric \current{current} creates magnetic field (electromagnet)
        \pause
        \item Changing magnetic field creates electric \current{current} (induction)
        \pause
        \item Motors convert electrical $\rightarrow$ mechanical \energy{energy}
        \pause
        \item Generators convert mechanical $\rightarrow$ electrical \energy{energy}
        \pause
        \item Transformers change \voltage{voltage} using induction
        \pause
        \item \power{Power} grid uses transformers to transmit \energy{energy} efficiently
    \end{itemize}
