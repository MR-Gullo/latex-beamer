...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig01.jpg}
\end{figure}
...
\end{center}
\note{[P0] "Alice follows a rabbit into a world where the rules change"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight,keepaspectratio]{phys12-quantum-fig05.jpg}
\end{figure}
...
\end{itemize}
\note{[P0] "Three temperature curves - study them carefully"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig08.jpg}
\end{figure}
...
\end{alertblock}
\note{[P0] "Classical physics prediction: dashed line shooting to infinity"\\\\
...
\Large $\boxed{E = nhf}$
\end{center}
Energy is not continuous. Energy exists only in discrete chunks.
\end{block}
...
\begin{itemize}
\item $n$ = integer (0, 1, 2, 3...)
\item $h = 6.626 \times 10^{-34}$ J·s (Planck's constant)
\item $f$ = frequency
\end{itemize}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig11.jpg}
\end{figure}
...
\end{center}
\note{[P0] "Max Planck revolutionized physics by questioning everything"\\\\
...
\begin{center}
\Large $\boxed{E = hf = \frac{hc}{\lambda}}$
\end{center}
\end{block}
...
\textbf{Key insights:}
\begin{itemize}
\item Higher frequency $\rightarrow$ higher energy per photon
\item Shorter wavelength $\rightarrow$ higher energy per photon
\item Planck's constant $h$ links energy to frequency
\end{itemize}
...
\item Wavelength: $\lambda = 580$ nm
\item $h = 6.626 \times 10^{-34}$ J·s, $c = 3.00 \times 10^8$ m/s
\end{itemize}
...
\textbf{Step 1 - Energy per photon:}
$$E = \frac{hc}{\lambda} = \frac{(6.626 \times 10^{-34})(3.00 \times 10^8)}{580 \times 10^{-9}} = 3.43 \times 10^{-19} \text{ J}$$
...
Blue light: shorter wavelength $\rightarrow$ higher frequency $\rightarrow$ \alert{higher energy per photon}

\pause
Red light: longer wavelength $\rightarrow$ lower frequency $\rightarrow$ lower energy per photon
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig17.jpg}
\end{figure}
...
\end{itemize}
\note{[P0] "Classic apparatus - evacuated tube with metal plate"\\\\
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig18.jpg}
\end{figure}
...
\note{[P0] "Flashlight beam as stream of individual photons"\\\\
...
\begin{itemize}
\item $KE_e$ = kinetic energy of ejected electron
\item $hf$ = photon energy
\item $BE$ = binding energy (work function)
\end{itemize}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig21.jpg}
\end{figure}

\pause
\textbf{Key features:}
\begin{itemize}
\item Below $f_0$: NO electrons ejected ($KE = 0$)
\item Above $f_0$: $KE$ increases linearly with $f$
\item Slope = $h$ (Planck's constant!)
\end{itemize}
\note{[P0] "Graph of electron kinetic energy vs incident light frequency"\\\\
...
\textbf{Given:}
\begin{itemize}
\item $\lambda = 420$ nm $= 4.20 \times 10^{-7}$ m
\item $BE = 2.71$ eV
\item $h = 6.626 \times 10^{-34}$ J·s, $c = 3.00 \times 10^8$ m/s
...
\textbf{Part (a) - Photon energy:}
$$E = \frac{hc}{\lambda} = \frac{(6.626 \times 10^{-34})(3.00 \times 10^8)}{4.20 \times 10^{-7}} = 4.74 \times 10^{-19} \text{ J}$$

\pause
Convert to eV: $E = \frac{4.74 \times 10^{-19}}{1.60 \times 10^{-19}} = \boxed{2.96 \text{ eV}}$

\pause
\vspace{0.3cm}

\textbf{Part (b) - Electron kinetic energy:}
$$KE_e = hf - BE = 2.96 \text{ eV} - 2.71 \text{ eV} = \boxed{0.25 \text{ eV}}$$
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{phys12-quantum-fig26.jpg}
\end{figure}
...
\end{itemize}
\note{[P0] "Solar cell: photoelectric effect in action"\\\\
...
\begin{center}
\Large $\boxed{p = \frac{h}{\lambda}}$
\end{center}
Photons carry momentum despite having zero mass.
\end{block}
...
\textbf{Key insights:}
\begin{itemize}
\item Shorter wavelength = higher momentum
...
\begin{enumerate}
\item Energy is quantized: $E = nhf$ (Planck) \pause
\item Photons are discrete packets: $E = hf$ (Planck/Einstein) \pause
\item Photoelectric effect proves light is quantized: $KE_e = hf - BE$ (Einstein) \pause
\item Photons carry momentum: $p = h/\lambda$ (Einstein/Compton) \pause
...
\begin{align}
E &= nhf \quad \text{(quantized energy - Planck)} \\
E &= hf = \frac{hc}{\lambda} \quad \text{(photon energy)} \\
KE_e &= hf - BE \quad \text{(photoelectric equation - Einstein)} \\
