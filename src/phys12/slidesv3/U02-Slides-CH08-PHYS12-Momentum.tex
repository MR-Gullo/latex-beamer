...
\end{figure}
\note{- Players collide with tremendous force\\\\
...
\note{[P0] "Airbags and crumple zones: pure impulse-momentum theorem"\\\\
...
\note{- Car 1 slows down, loses momentum\\\\
...
\note{[P0] "Angular momentum is the rotational version of linear momentum"\\\\
...
\note{[P0] "Elastic collision diagram"\\\\
...
\note{[P0] "Inelastic collision: objects stick together"\\\\
...
\note{[P0] "2D collisions are more complex"\\\\
