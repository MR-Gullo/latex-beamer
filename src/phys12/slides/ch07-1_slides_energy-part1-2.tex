...
\vspace{0.5cm}
\begin{center}
		\includegraphics[width=0.5\linewidth]{pasted-images/ch07-1_slides_energy-part1-2-07-48-38.png}
	\end{center}
\end{column}
...
\centering
\begin{center}
		\includegraphics[width=0.6\linewidth]{pasted-images/ch07-1_slides_energy-part1-2-12-26-59.png}
	\end{center}
\end{figure}
\end{frame}
