...
\pause
\textbf{VIDEO SUGGESTION:} Bungee jump showing gravitational PE $\rightarrow$ KE $\rightarrow$ elastic PE (45-90 sec)
\end{frame}
...
\vspace{0.5cm}
\begin{center}
		\includegraphics[width=\linewidth]{pasted-images/ch07-1_slides_energy-part1-2-07-48-38.png}
	\end{center}
\end{column}
...
\begin{center}
\textit{Image suggestion: Flow diagram showing mechanical energy $\rightarrow$ heat energy via friction}
