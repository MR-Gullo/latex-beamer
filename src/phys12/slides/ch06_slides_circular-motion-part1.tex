...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{CH6/phys12-mechanics-circular-motion-arc.png}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{CH6/phys12-mechanics-angular-velocity-wheel.png}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{CH6/phys12-mechanics-centripetal-acceleration.png}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{CH6/phys12-mechanics-centripetal-force-diagram.png}
\end{figure}
\end{frame}
