...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{12 Formula/phys12-formulas-relativity-thermodynamics.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{12 Formula/phys12-formulas-newton-relativity-thermodynamics.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{12 Formula/phys12-navigation-compass-directions.png}
