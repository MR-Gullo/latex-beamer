...
\begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.7\linewidth]{CH7/Screenshot 2024-11-19 071730.png}
        \end{figure}
        \begin{figure}
            \centering
            \includegraphics[width=0.7\linewidth]{CH7/Screenshot 2024-11-19 073518.png}
        \end{figure}
    \end{column}
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.7\linewidth]{CH7/phys12-circuits-kirchhoffs-loop-rule-example.png}
        \end{figure}
        \begin{figure}
            \centering
            \includegraphics[width=0.7\linewidth]{CH7/Screenshot 2024-11-19 074004.png}
        \end{figure}
    \end{column}
\end{columns}
\end{frame}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{CH7/Screenshot 2024-11-19 090237.png}
\end{figure}
