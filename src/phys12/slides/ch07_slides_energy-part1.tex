...
A 30.0-kg package on a roller belt conveyor system
\pause
moves at 0.500 m/s.
\pause
\vspace{0.5cm}
...
\end{itemize}
\pause
\textbf{Key insight:} Energy conservation allows us to solve these problems without analyzing the forces along the path
\end{frame}
...
\pause
\item Total mechanical energy is conserved, only valid for conservative forces
\end{itemize}
\end{alertblock}
\end{frame}
