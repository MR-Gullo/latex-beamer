...
% Title information
\title[Linear Momentum]{PHYS12 CH8: Linear Momentum \& Collisions}
...
\begin{frame}
\frametitle{Subatomic Collisions and Momentum}
\begin{block}{Significance}
Conservation of momentum is critical in analyzing subatomic particle interactions.
\end{block}
...
\item Experimental Verification:
    \begin{itemize}
    \item Analyzing tracks in bubble chambers
    \item Confirms momentum conservation even at microscopic scales
    \end{itemize}
\item Discovery of the Neutrino:
    \begin{itemize}
    \item Momentum appeared to be missing in beta decay
    \item Pauli proposed an unseen particle (neutrino) carried the missing momentum
    \item Later confirmed experimentally
    \end{itemize}
\item Quark Structure:
    \begin{itemize}
    \item Scattering experiments revealed proton structure
    \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{Evidence for Quarks}
\begin{block}{Scattering Experiments}
Figure 8.5 illustrates how a particle scattering backward from another implies that its target is massive and dense.
\end{block}

\pause
\begin{itemize}[<+->]
\item Experiments seeking evidence that quarks make up protons (particles in nuclei)
\item High-energy electrons were scattered off of protons (hydrogen nuclei)
\item Electrons occasionally scattered straight backward
\end{itemize}
\end{frame}

\begin{frame}
    \begin{center}
		\includegraphics[width=\linewidth]{pasted-images/Fig8-5_ch08_slides_momentum-09-39-41.png}
	\end{center}
\end{frame}

\begin{frame}
\frametitle{Scattering Analysis}
\begin{block}{Key Observation}
A subatomic particle scatters straight backward from a target particle.
\end{block}

\pause
\begin{itemize}[<+->]
\item This backward scattering implies a very small and very dense particle makes up the proton
\item This observation is considered nearly direct evidence of quarks
\item The analysis relied on the same conservation of momentum principle that works on the large scale
\end{itemize}
\end{frame}
