...
\begin{center}
\begin{tikzpicture}[
    chemical/.style={draw=primaryblue, circle, minimum size=2cm, fill=lightgray!30, align=center},
    process/.style={draw=primaryblue, rectangle, rounded corners, minimum width=2.5cm, minimum height=1.2cm, fill=white, align=center},
