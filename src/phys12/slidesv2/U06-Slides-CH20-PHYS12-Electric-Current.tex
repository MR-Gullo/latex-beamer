...
\begin{frame}
    ...
    \begin{center}
        \begin{tabular}{cc}
            \includegraphics[width=0.4\linewidth]{phys12-circuits-capacitor-discharge-curve.png}
            &
            \includegraphics[width=0.35\linewidth]{phys12-electrostatics-charge-interactions.png} \\
