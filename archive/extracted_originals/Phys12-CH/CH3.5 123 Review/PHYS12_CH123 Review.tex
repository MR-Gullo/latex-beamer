...
\begin{tikzpicture}[scale=0.7]
    ...
    % Seagull
    \node[draw, circle, fill=gray!30] at (2,3) (seagull) {\includegraphics[width=0.5cm]{/api/placeholder/50/50}};
...
\begin{tikzpicture}[scale=0.7]
    ...
    % Quarterback
    \node[draw, circle, fill=red!30] at (1,1) (qb) {\includegraphics[width=0.5cm]{/api/placeholder/50/50}};
    ...
    % Receiver
    \node[draw, circle, fill=green!30] at (9,1) (receiver) {\includegraphics[width=0.5cm]{/api/placeholder/50/50}};
